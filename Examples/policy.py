...
# The SL policy network pσ(a| s) alternates between convolutional
# layers with weights σ, and rectifier nonlinearities. A final softmax
# layer outputs a probability distribution over all legal moves a. The
...
if __name__ == "__main__":
    ...
    max_steps = 1e9
    train_model(model, N, Nfeat, build_feed_dict, normalization, loss_func, train_data_dir, val_data_dir, lr_base,
                lr_half_life, max_steps, just_validate=False)